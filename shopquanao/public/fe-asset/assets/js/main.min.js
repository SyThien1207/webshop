        ...
        var e,
            ...
            c = {
                ...
                minipopup: {
                    ...
                    action: '<a href="/gio-hang" class="btn viewcart">Giỏ hàng</a><a href="thanh-toan" class="btn btn-dark checkout">Thanh toán</a>',
                    delay: 4e3,
                    space: 20,
                    template:
                ...
                filterSlider: function () {
                    ...
                    null != e &&
                        ...
                        e.noUiSlider.on("update", function (values, handle) {
                            ...
                            // Cập nhật giá trị cho các input ẩn để gửi đi khi submit form
                ...
                }),
                {
                    init: function () {
                        ...
                        (n.className = "wishlist-popup"),
                            ...
                            (o.innerText = "Đã thêm vào danh sách!"),
