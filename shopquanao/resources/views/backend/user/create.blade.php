         ...
         <div class="row">
            <div class="col-md-6">
               <div class="mb-3">
                  ...
                  <input type="text" value="{{old('username')}}" name="username" class="form-control" placeholder="Tên đăng nhập"required />
               </div>
               <div class="mb-3">
               ...
               <div class="mb-3">
                  ...
                  <select name="roles" id="gender" class="form-select" required>
