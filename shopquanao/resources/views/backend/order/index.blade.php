      ...
      <div class="row my-2 align-items-center">
         <div class="col-5">
            <ul class="manager">
               ...
               <span>|</span>
               <span><a class="bi bi-bookmark-check-fill" href="#"> Chưa xử lý:{{ $activeCategoryCount }}</a></span>
               <span>|</span>
               <span><a class="bi bi-trash2" href="{{route("admin.post.trash")}}"> Rác:{{ $activeCategoryCount2 }}</a></span>
            </ul>
         </div>
         <div class="col-md-5 text-end">
            <form action="{{ route('admin.post.index') }}" method="GET" class="d-inline">
         ...
         <div class="col-md-2 text-end">
            <a href="{{route('admin.post.create')}}" class="btn btn-secondary">Thêm mới</a>
            ...
            <tr class="datarow">
               ...
               <td>
                  ...
                  <div class="function_style">
                     ...
                     <a href="#" class="text-info mx-1 view-details" data-id="{{ $row->id }}" title="Chi tiết đơn hàng">
                                <i class="bi bi-eye"></i>
                            </a>
                     @if ($row->status==4)
                     <a href="{{route("admin.order.destroy",$agrs)}}" class="text-danger mx-1" title="Hủy đơn hàng">
                        <i class="bi bi-x-circle-fill"></i>
                        @elseif ($row->status==5 )
                        <a href="{{route("admin.order.delete",$agrs)}}" class="text-danger mx-1" title="xóa">
               ...
               <td> {{ \Carbon\Carbon::parse($row->create_at)->format('d/m/Y') }}
               </td>
               <td>
    @php
    $agrs = ['id' => $row->id];
